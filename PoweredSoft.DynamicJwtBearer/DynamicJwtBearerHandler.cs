...
public class DynamicJwtBearerHandler : JwtBearerHandler
{
    ...
    /// If the 'Bearer' token is found, it is validated using 
    ...
    protected override async Task<AuthenticateResult> HandleAuthenticateAsync()
    {
        ...
        try
        {
            ...
            var currentConfiguration = await this.dynamicJwtBearerHanderConfigurationResolver
                .ResolveCurrentOpenIdConfiguration(Context);
            ...
            foreach (var validator in from validator in Options.SecurityTokenValidators
                                      where validator.CanReadToken(token)
                                      select validator)
            {
